                ...
                <div className="row">
                    <div className="col-xl-6">
                        <div className="always-working__left">
                            <div className="section-title text-left">
                                <span className="section-title__tagline">About Wostin Company</span>
                                <h2 className="section-title__title">Always Working for a Clean Tomorrow</h2>
                            </div>
                            <p className="always-working__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    ...
                    <div className="col-xl-6">
                        <div className="always-working__right">
                            <div className="always-working__img wow slideInRight" data-wow-delay="100ms"
