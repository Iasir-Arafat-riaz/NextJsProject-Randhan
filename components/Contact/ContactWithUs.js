            ...
            <div className="row">
                <div className="col-xl-6 col-lg-6">
                    <div className="contact-one__left">
                        <div className="section-title text-left">
                            ...
                            <h2 className="section-title__title">Have Questions? Feel Free to Write Us</h2>
                        </div>
                        <p className="contact-one__text">Lorem ipsum dolor sit amet, consectetur notted adipis not icing
                ...
                <div className="col-xl-6 col-lg-6">
                    <div className="contact-one__right">
                        <form action="http://layerdrops.com/wostin/main-html/assets/inc/sendemail.php" className="contact-one__form contact-form-validated"
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    ...
                                    <div className="contact-one__btn-box">
                                        <button type="submit" className="thm-btn contact-one__btn">Send a
                                            Message</button>
                                    </div>
                                </div>
                            </div>
