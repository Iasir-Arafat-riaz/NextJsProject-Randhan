          ...
          <div className="row">
            <div className="col-md-3 ">
              <Card className="shadow serviceInnerContent pt-4">
                ...
                <Card.Body>
                  <h4 className="text-center"><b>Farmer</b></h4>
            ...
            <div className="col-md-3"> <Card className="shadow serviceInnerContent pt-4">
                <div>
                  <Image src={buyer} alt="image"></Image>
                </div>
                <Card.Body>
                  <h4 className="text-center"><b>Buyer</b></h4>
                  <Card.Text className="text-center">
                  We source directly from the farmers and supply agriculture produce in bulk quantity to large enterprises, modern trade retailers
                  </Card.Text>
                </Card.Body>
              </Card></div>
            <div className="col-md-3"> <Card className="shadow serviceInnerContent pt-4">
                ...
                <Card.Body>
                  <h4 className="text-center"><b>Funder</b></h4>
                  <Card.Text className="text-center">
                  We use technology and data to enable institutions and individuals to support in creating access to finance for the farmers
            ...
            <div className="col-md-3"> <Card className="shadow serviceInnerContent pt-4">
                ...
                <Card.Body>
                  <h4 className="text-center"><b>Retailer</b></h4>
                  <Card.Text className="text-center">
                  We work with agricultural input companies and service providers, offering quality agriculture input and advisory services to the farmers
                  </Card.Text>
                </Card.Body>
              </Card></div>
          </div>
