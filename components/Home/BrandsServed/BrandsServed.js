...
const BrandsServed = () => {
  return (
    <div className=" justify-content-center py-4 px-4 ">
      <Swiper
      ...
      >
        <SwiperSlide><Brand data={{img:brandImg1}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg2}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg3}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg4}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg5}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg1}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg2}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg3}}/></SwiperSlide>
        <SwiperSlide><Brand data={{img:brandImg4}}/></SwiperSlide>
